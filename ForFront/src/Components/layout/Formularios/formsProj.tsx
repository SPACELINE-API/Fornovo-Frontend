  ...
  const handleSubmit = async (values: typeof form.values) => {
    ...
    try {
      ...
      const payload = {
        ...
        data_inicio:
          values.data_inicio instanceof Date
            ...
            <Box style={{ maxWidth: rem(250) }}>
              ...
              <TextInput
                ...
                onChange={(e) =>
                  form.setFieldValue(
                    'data_inicio',
                    e.target.value ? new Date(e.target.value + 'T00:00:00') : (null as any),
                  )
                }
              />
              {form.errors.data_inicio && (
                <Text color="red" size="xs" mt={4}>
                  {String(form.errors.data_inicio)}
                </Text>
              )}
            </Box>
